Use the [badge component](/components/badge/) to indicate the status of something, such as an item on a [task list](https://design-system.service.gov.uk/patterns/task-list-pages).
